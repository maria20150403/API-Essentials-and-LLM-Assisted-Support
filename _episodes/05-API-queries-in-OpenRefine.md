...
>2. What are the steps to create a new column called _HandleLink_ which is a link to the catalog record for that item? (hint: `"http://hdl.handle.net/10079/bibid/" + ?`)
>
>>## Solution
>>1. Select _VoyagerData_ -> 'Edit column' -> 'Add column based on this column...'
>>- New column name: _Location_
>>- Add the expression: `value.parseJson().record[0].item[0].loccode`
>>- Click 'OK'
>>2. Select _VoyagerData_ -> 'Edit column' -> 'Add column based on this column...'
